...
function checkAnswer2() {
    ...
    if (answer2.toLowerCase() === "alice") { // Check if the answer is correct
        // Set the flag in sessionStorage
...
function checkAnswer4() {
    ...
    if (answer4.toLowerCase() === "dorothy") { // Check if the answer is correct
        // Set the flag in sessionStorage
...
function checkAnswer6() {
    ...
    if (answer6.toLowerCase() === "dorothy") { // Check if the answer is correct
        // Set the flag in sessionStorage
